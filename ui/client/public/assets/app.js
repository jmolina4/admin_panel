...
(function () {
  ...
  appwrite2.setEndpoint({env: {APP_WRITE_API_ENDPOINT: "http://localhost/v1", APP_WRITE_PROJECT_ID: ""}}.env.APP_WRITE_API_ENDPOINT).setProject({env: {APP_WRITE_API_ENDPOINT: "http://localhost/v1", APP_WRITE_PROJECT_ID: ""}}.env.APP_WRITE_PROJECT_ID);
  ...
  __vue_render__._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__ = "data-v-6a6ca5a7";
    /* module identifier */
